...
//target 1: zeta_loc_lam = f(Re_lam) for different alpha at constant AR
  ...
  Modelica.Units.SI.Diameter d_hyd_1_1=10e-3;
  Modelica.Units.SI.Diameter d_hyd_2_1=(A_2_1*4/PI)^0.5;
  ...
  Modelica.Units.SI.Length C_2_1=(A_2_1*4/PI)^0.5*PI;
  Modelica.Units.SI.Length L_1_1=0*d_hyd_1_1;
  Modelica.Units.SI.Length L_2_1=0*d_hyd_1_1;
  Modelica.Units.SI.Length L_d_1[n]={0.5*(d_hyd_2_1 - d_hyd_1_1)/max(MIN, tan(
      alpha[i])) for i in 1:n};
  Modelica.Units.SI.ReynoldsNumber Re_1=input_Re*199 + 1;
  Modelica.Units.SI.MassFlowRate input_mdot_1[n]=ones(n)*Re_1*eta*A_1_1/
      d_hyd_1_1;

  Modelica.Units.SI.Pressure DP_1[n];
  Real DP_plot_1[n]={DP_1[i] for i in 1:n};
  Modelica.Units.SI.Velocity velocity_1[n]={input_mdot_1[i]/(rho*A_1_1) for i
       in 1:n};
...
//target 2: zeta_tot = f(Re) for different alpha at constant AR
  Modelica.Units.SI.Diameter d_hyd_1_2=10e-3;
  Modelica.Units.SI.Diameter d_hyd_2_2=(A_2_2*4/PI)^0.5;
  Real AR_2=2;
  ...
  Modelica.Units.SI.Length C_2_2=(A_2_2*4/PI)^0.5*PI;
  Modelica.Units.SI.Length L_1_2=1*d_hyd_1_2;
  Modelica.Units.SI.Length L_2_2=1*d_hyd_2_2;
  Modelica.Units.SI.Length L_d_2[n]={0.5*(d_hyd_2_2 - d_hyd_1_2)/max(MIN, tan(
      alpha[i])) for i in 1:n};
  Modelica.Units.SI.ReynoldsNumber Re_2=input_Re*(1e6 - 1) + 1;
  Modelica.Units.SI.MassFlowRate input_mdot_2[n]=ones(n)*Re_2*eta*A_1_2/
      d_hyd_1_2;
  Modelica.Units.SI.Pressure DP_2[n];
  Real DP_plot_2[n]={DP_2[i] for i in 1:n};
  Modelica.Units.SI.Velocity velocity_2[n]={input_mdot_2[i]/(rho*A_1_2) for i
       in 1:n};
...
//target 3: zeta_tot = f(alpha) for different Re at constant AR
  ...
  Modelica.Units.SI.Diameter d_hyd_1_3=10e-3;
  Modelica.Units.SI.Diameter d_hyd_2_3=(A_2_3*4/PI)^0.5;
  Modelica.Units.SI.Angle alpha_3=(input_Re*85 + 5)*PI/180;
  ...
  Modelica.Units.SI.Length C_2_3=(A_2_3*4/PI)^0.5*PI;
  Modelica.Units.SI.Length L_1_3=0*d_hyd_1_3;
  Modelica.Units.SI.Length L_2_3=0*d_hyd_1_3;
  Modelica.Units.SI.Length L_d_3=0.5*(d_hyd_2_3 - d_hyd_1_3)/max(MIN, tan(
      alpha_3));
  Real L_d_3ToR_3=L_d_3/(d_hyd_1_3/2);

  Modelica.Units.SI.ReynoldsNumber Re_3[5]={1e5,2e5,4e5,6e5,1e6};
  Modelica.Units.SI.MassFlowRate input_mdot_3[m]={Re_3[i]*eta*A_1_3/d_hyd_1_3
      for i in 1:m};
  Modelica.Units.SI.Pressure DP_3[m];
  Real DP_plot_3[m]={DP_3[i] for i in 1:m};
  Modelica.Units.SI.Velocity velocity_3[m]={input_mdot_3[i]/(rho*A_1_3) for i
       in 1:m};
...
//target 4: dp_tot = f(m_flow) for different alpha at constant AR
  Modelica.Units.SI.Diameter d_hyd_1_4=1e-1;
  Modelica.Units.SI.Diameter d_hyd_2_4=(A_2_4*4/PI)^0.5;
  Real AR_4=2;
  ...
  Modelica.Units.SI.Length C_2_4=(A_2_4*4/PI)^0.5*PI;
  Modelica.Units.SI.Length L_1_4=1*d_hyd_1_4;
  Modelica.Units.SI.Length L_2_4=1*d_hyd_1_4;
  Modelica.Units.SI.Length L_d_4[n]={0.5*(d_hyd_2_4 - d_hyd_1_4)/max(MIN, tan(
      alpha[i])) for i in 1:n};
  Modelica.Units.SI.ReynoldsNumber Re_4=input_Re*(1e4 - 1) + 1;
  Modelica.Units.SI.MassFlowRate input_mdot_4[n]=ones(n)*Re_4*eta*A_1_4/
      d_hyd_1_4;
  Modelica.Units.SI.Pressure DP_4[n];
  Real DP_plot_4[n]={DP_4[i] for i in 1:n};
  Modelica.Units.SI.Velocity velocity_4[n]={input_mdot_4[i]/(rho*A_1_4) for i
       in 1:n};
