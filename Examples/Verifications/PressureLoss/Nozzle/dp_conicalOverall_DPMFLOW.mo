...
model dp_conicalOverall_DPMFLOW "Verification of function dp_concialOverall_DP"
  ...
  Modelica.Units.SI.ReynoldsNumber input_Re=input_Re_0.y;

  //Nozzle variables
  Real AR[6]={0.64,0.45,0.25,0.16,0.125,0.10};

  //fluid property variables
  Modelica.Units.SI.DynamicViscosity eta=17.1e-6 "Dynamic viscosity of fluid";
  Modelica.Units.SI.Density rho=1.2 "Density of fluid";

  //target 1: zeta_loc_lam = f(Re_lam) for different alpha at constant AR
  Modelica.Units.SI.Angle alpha_1[5]={2.5,5,10,15,20}*PI/180;
  Modelica.Units.SI.Angle alpha[5]={10,20,40,60,80}*PI/180;
  parameter Integer n=size(alpha, 1);
  Modelica.Units.SI.Diameter d_hyd_1_1=40e-3;
  Real AR_1=5/10;
  Modelica.Units.SI.Diameter d_hyd_2_1=d_hyd_1_1*AR_1^0.5;
  Modelica.Units.SI.Area A_1_1=PI*(d_hyd_1_1)^2/4;
  Modelica.Units.SI.Area A_2_1=AR_1*A_1_1;
  Modelica.Units.SI.Length C_1_1=PI*d_hyd_1_1;
  Modelica.Units.SI.Length C_2_1=PI*d_hyd_2_1;
  Modelica.Units.SI.Length L_1_1=0*d_hyd_1_1;
  Modelica.Units.SI.Length L_2_1=0*d_hyd_1_1;
  Modelica.Units.SI.Length L_trans_1[n]={0.5*abs(d_hyd_2_1 - d_hyd_1_1)/max(MIN,
      tan(alpha_1[i])) for i in 1:n};
  Modelica.Units.SI.ReynoldsNumber Re_1=input_Re*999 + 1;
  Modelica.Units.SI.MassFlowRate input_mdot_1[n]=ones(n)*Re_1*eta*A_2_1/
      d_hyd_2_1;

  Modelica.Units.SI.Pressure DP_1[n];
  Real DP_plot_1[n]={DP_1[i] for i in 1:n};
  Modelica.Units.SI.Velocity velocity_1[n]={input_mdot_1[i]/(rho*A_2_1) for i
       in 1:n};
  ...
  Modelica.Units.SI.Diameter d_hyd_1_2=40e-3;
  Real AR_2=50/100;
  Modelica.Units.SI.Diameter d_hyd_2_2=d_hyd_1_2*AR_2^0.5;
  Modelica.Units.SI.Area A_1_2=PI*(d_hyd_1_2)^2/4;
  Modelica.Units.SI.Area A_2_2=AR_1*A_1_2;
  Modelica.Units.SI.Length C_1_2=PI*d_hyd_1_2;
  Modelica.Units.SI.Length C_2_2=PI*d_hyd_2_2;
  Modelica.Units.SI.Length L_1_2=0*d_hyd_1_2;
  Modelica.Units.SI.Length L_2_2=0*d_hyd_2_2;
  Modelica.Units.SI.Length L_trans_2[n]={0.5*abs(d_hyd_2_2 - d_hyd_1_2)/max(MIN,
      tan(alpha[i])) for i in 1:n};
  Modelica.Units.SI.ReynoldsNumber Re_2=input_Re*(1e7 - 1) + 1;
  Modelica.Units.SI.MassFlowRate input_mdot_2[n]=ones(n)*Re_2*eta*A_2_2/
      d_hyd_2_2;
  Modelica.Units.SI.Pressure DP_2[n];
  Real DP_plot_2[n]={DP_2[i] for i in 1:n};
  Modelica.Units.SI.Velocity velocity_2[n]={input_mdot_2[i]/(rho*A_2_2) for i
       in 1:n};
  ...
  Modelica.Units.SI.ReynoldsNumber Re_3[5]={1e5,2e5,6e5,1e6,1e7};
  parameter Integer m=size(Re_3, 1);
  Modelica.Units.SI.Diameter d_hyd_1_3=40e-3;
  Real AR_3=50/100;
  Modelica.Units.SI.Diameter d_hyd_2_3=d_hyd_1_3*AR_3^0.5;
  Modelica.Units.SI.Angle alpha_3=(input_Re*80 + 1)*PI/180;
  Modelica.Units.SI.Angle alpha_3_plot=alpha_3*180/PI;
  Modelica.Units.SI.Area A_1_3=PI*(d_hyd_1_3)^2/4;
  Modelica.Units.SI.Area A_2_3=AR_3*A_1_3;
  Modelica.Units.SI.Length C_1_3=PI*d_hyd_1_3;
  Modelica.Units.SI.Length C_2_3=PI*d_hyd_2_3;
  Modelica.Units.SI.Length L_1_3=0*d_hyd_1_3;
  Modelica.Units.SI.Length L_2_3=0*d_hyd_1_3;
  Modelica.Units.SI.Length L_trans_3=0.5*abs(d_hyd_2_3 - d_hyd_1_3)/max(MIN,
      tan(alpha_3));
  Real L_trans_3ToR_3=L_trans_3/(d_hyd_1_3/2);

  Modelica.Units.SI.MassFlowRate input_mdot_3[m]={Re_3[i]*eta*A_2_3/d_hyd_2_3
      for i in 1:m};
  Modelica.Units.SI.Pressure DP_3[m];
  Real DP_plot_3[m]={DP_3[i] for i in 1:m};
  Modelica.Units.SI.Velocity velocity_3[m]={input_mdot_3[i]/(rho*A_2_3) for i
       in 1:m};
  ...
  Modelica.Units.SI.Diameter d_hyd_1_4=4e-1;
  Real AR_4=64/100;
  Modelica.Units.SI.Diameter d_hyd_2_4=d_hyd_1_4*AR_4^0.5;
  Modelica.Units.SI.Area A_1_4=PI*(d_hyd_1_4)^2/4;
  Modelica.Units.SI.Area A_2_4=AR_4*A_1_4;
  Modelica.Units.SI.Length C_1_4=PI*d_hyd_1_4;
  Modelica.Units.SI.Length C_2_4=PI*d_hyd_2_4;
  Modelica.Units.SI.Length L_1_4=1*d_hyd_1_4;
  Modelica.Units.SI.Length L_2_4=1*d_hyd_1_4;
  Modelica.Units.SI.Length L_trans_4[n]={0.5*abs(d_hyd_2_4 - d_hyd_1_4)/max(MIN,
      tan(alpha[i])) for i in 1:n};
  Modelica.Units.SI.ReynoldsNumber Re_4=input_Re*(1e4 - 1) + 1;
  Modelica.Units.SI.MassFlowRate input_mdot_4[n]=ones(n)*Re_4*eta*A_2_4/
      d_hyd_2_4;
  Modelica.Units.SI.Pressure DP_4[n];
  Real DP_plot_4[n]={DP_4[i] for i in 1:n};
  Modelica.Units.SI.Velocity velocity_4[n]={input_mdot_4[i]/(rho*A_2_4) for i
       in 1:n};
  ...
  Modelica.Blocks.Sources.Sine input_Re_1(
    offset=0,
    startTime=0,
    f=1) annotation (Placement(transformation(extent={{-66,-80},{-46,-60}})));
