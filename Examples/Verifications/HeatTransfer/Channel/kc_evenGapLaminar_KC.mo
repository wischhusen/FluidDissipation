...
model kc_evenGapLaminar_KC "Verification of function kc_evenGapLaminar_KC"
  ...
  Modelica.Units.SI.MassFlowRate m_flow_1[n](start=ones(n)*1e-3);
  Modelica.Units.SI.MassFlowRate m_flow_2[n](start=ones(n)*1e-3);
  Modelica.Units.SI.MassFlowRate m_flow_3[n](start=ones(n)*1e-3);
  Modelica.Units.SI.MassFlowRate m_flow_4[n](start=ones(n)*1e-3);
  Modelica.Units.SI.CoefficientOfHeatTransfer kc_OUT_1[n]={Nu[i]*lambda[i]/
      d_hyd for i in 1:n};
  Modelica.Units.SI.CoefficientOfHeatTransfer kc_OUT_2[n]={Nu[i]*lambda[i]/
      d_hyd for i in 1:n};
  Modelica.Units.SI.CoefficientOfHeatTransfer kc_OUT_3[n]={Nu[i]*lambda[i]/
      d_hyd for i in 1:n};
  Modelica.Units.SI.CoefficientOfHeatTransfer kc_OUT_4[n]={Nu[i]*lambda[i]/
      d_hyd for i in 1:n};
...
public
  ...
  Modelica.Units.SI.ReynoldsNumber Re_2[n]={abs(m_flow_2[i])*d_hyd/(eta[i]*
      Modelica.Constants.pi*d_hyd*d_hyd/4) for i in 1:n};
  Modelica.Units.SI.ReynoldsNumber Re_3[n]={abs(m_flow_3[i])*d_hyd/(eta[i]*
      Modelica.Constants.pi*d_hyd*d_hyd/4) for i in 1:n};
  Modelica.Units.SI.ReynoldsNumber Re_4[n]={abs(m_flow_4[i])*d_hyd/(eta[i]*
      Modelica.Constants.pi*d_hyd*d_hyd/4) for i in 1:n};
