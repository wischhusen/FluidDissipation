...
model kc_twoPhase_boilingConvective_KC
  ...
  Modelica.Units.SI.CoefficientOfHeatTransfer kc_l[4]
    "Heat transfer coefficient of liquid phase";
  Modelica.Units.SI.CoefficientOfHeatTransfer kc_g[4]
    "Heat transfer coefficient of gasous phase";
  Modelica.Units.SI.CoefficientOfHeatTransfer kc_conv[4]
    "Convective two phase heat transfer coefficient";
  Real kc_norm[4] "Normalised convective two phase heat transfer coefficient";

  //Boundary conditions
  parameter Modelica.Units.SI.MassFlowRate m_flow[4]={232,380,734,1353};
  parameter Modelica.Units.SI.Pressure p=0.007*220.6e5 "Pressure";
  Modelica.Units.SI.MassFraction x_flow "Steam quality";

  //Geometry
  parameter Modelica.Units.SI.Length d_hyd=0.0254 "Hydraulic diameter of pipe";

  //Media data
  parameter Modelica.Units.SI.SpecificHeatCapacityAtConstantPressure cp_l=
      4231.48 "Specific heat capacity of liquid phase";
  parameter Modelica.Units.SI.SpecificHeatCapacityAtConstantPressure cp_g=
      2135.34 "Specific heat capacity of gasous phase";

  parameter Modelica.Units.SI.DynamicViscosity eta_l=0.000249248
    "Dynamic viscosity of liquid phase";
  parameter Modelica.Units.SI.DynamicViscosity eta_g=1.26567e-5
    "Dynamic viscosity of gasous phase";

  parameter Modelica.Units.SI.ThermalConductivity lambda_l=0.680874
    "Thermal conductivity of liquid phase";
  parameter Modelica.Units.SI.ThermalConductivity lambda_g=0.025812
    "Thermal conductivity of gasous phase";

  parameter Modelica.Units.SI.Density rho_l=949.243 "Density of liquid phase";
  parameter Modelica.Units.SI.Density rho_g=0.886356 "Density of gasous phase";

  parameter Modelica.Units.SI.Pressure p_crit=220.6e5
