...
record Diffuser "Input for diffuser"
  ...
  Modelica.Units.SI.Length L_d=L_1
  ...
  Modelica.Units.SI.Area A_1=PI*0.01^2/4
    ...
    annotation (Dialog(group="Diffuser"));
  Modelica.Units.SI.Area A_2=2*A_1
    "Large constant cross sectional area at outlet of diffuser"
    annotation (Dialog(group="Diffuser"));
  Modelica.Units.SI.Length C_1=PI*0.01 "Small perimeter at inlet of diffuser"
    annotation (Dialog(group="Diffuser"));
  Modelica.Units.SI.Length C_2=2*C_1 "Large perimeter at outlet of diffuser"
    annotation (Dialog(group="Diffuser"));

  Modelica.Units.SI.Length L_1=0.1
    "Length of straight pipe before diffuser section"
    annotation (Dialog(group="Straight pipe"));
  Modelica.Units.SI.Length L_2=L_1
