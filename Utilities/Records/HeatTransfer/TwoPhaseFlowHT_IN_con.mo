...
record TwoPhaseFlowHT_IN_con
  ...
  Modelica.Units.SI.Length perimeter=Modelica.Constants.pi*0.1
    "Wetted perimeter" annotation (Dialog(group="Geometry"));
  ...
  Modelica.Units.SI.Pressure p_crit=220.89e5 "Critical pressure of fluid"
