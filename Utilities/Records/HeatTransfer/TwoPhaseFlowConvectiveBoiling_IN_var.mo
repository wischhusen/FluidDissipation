...
record TwoPhaseFlowConvectiveBoiling_IN_var
  ...
  Modelica.Units.SI.CoefficientOfHeatTransfer kc_l=1000
    "Local liquid phase heat transfer coefficient";
  Modelica.Units.SI.CoefficientOfHeatTransfer kc_g=1000
    "Local gas phase heat transfer coefficient";
  Modelica.Units.SI.Density rho_l=943.11 "Liquid density"
    annotation (Dialog(group="Fluid properties"));
  Modelica.Units.SI.Density rho_g=1.1220 "Gas density"
    annotation (Dialog(group="Fluid properties"));
  Modelica.Units.SI.Pressure p=100e5 "Pressure"
  ...
  Modelica.Units.SI.ThermalConductivity lambda_wall=2
    "Thermal conductivity of wall"
    annotation (Dialog(group="Properties of wall"));
