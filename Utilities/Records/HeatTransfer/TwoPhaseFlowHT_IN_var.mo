...
//     annotation (Dialog(group="Choices"));
  ...
  //fluid properties
  Modelica.Units.SI.SpecificHeatCapacityAtConstantPressure cp_l=4.19e3
    "Specific heat capacity of liquid"
    annotation (Dialog(group="Fluid properties"));
  Modelica.Units.SI.ThermalConductivity lambda_l=0.58
    "Thermal conductivity of liquid"
    annotation (Dialog(group="Fluid properties"));
  Modelica.Units.SI.Density rho_g=1.1220 "Density of gas" annotation (Dialog(
        group="Fluid properties", enable=if target == FluidDissipation.Utilities.Types.TwoPhaseHeatTransferTarget.BoilHor
  ...
  Modelica.Units.SI.Pressure pressure=2e5 "Mean pressure of fluid"
    annotation (Dialog(group="Fluid properties"));
  Modelica.Units.SI.SpecificEnthalpy dh_lg=2202.08e3
    "Evaporation enthalpy of fluid" annotation (Dialog(group="Fluid properties",
  ...
  Modelica.Units.SI.HeatFlux qdot_A=0 "Heat flux at boiling" annotation (Dialog(
        group="Input", enable=if target == FluidDissipation.Utilities.Types.TwoPhaseHeatTransferTarget.BoilHor
           or target == FluidDissipation.Utilities.Types.TwoPhaseHeatTransferTarget.BoilVer
           then true else false));
