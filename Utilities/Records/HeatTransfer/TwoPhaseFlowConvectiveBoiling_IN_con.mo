...
record TwoPhaseFlowConvectiveBoiling_IN_con
  ...
  Modelica.Units.SI.Pressure p_crit=220.64e5 "Pressure at critical point"
  ...
  Modelica.Units.SI.Length s=0.005 "Wall thickness"
    annotation (Dialog(group="Geometry"));
  Modelica.Units.SI.Length d_hyd=0.01 "Hydraulic Diameter"
    annotation (Dialog(group="Geometry"));
