...
record dp_corrugatedPlate_1ph_IN_con
  ...
  Modelica.Units.SI.Length Length(min=1e-2) = 0
  ...
  Modelica.Units.SI.Length Width(min=1e-2) = 0
    "width of the heat exchanger plates in flow direction"
    annotation (Dialog(group="HeatExchanger"));
  Modelica.Units.SI.Length amp(min=1e-10) = 0 "amplitude of corrugated plate"
    annotation (Dialog(group="HeatExchanger"));
  ...
  Modelica.Units.SI.Angle phi=0 "Corrugation angle"
    annotation (Dialog(group="HeatExchanger"));
