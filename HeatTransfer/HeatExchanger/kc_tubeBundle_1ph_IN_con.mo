...
record kc_tubeBundle_1ph_IN_con
 ...
 extends Modelica.Icons.Record;
  Modelica.Units.SI.Area A_front(min=1e-6) = 1
    "Cross sectional area in front of the tube row or bundle"
    annotation (Dialog(group="Geometry"));
  Modelica.Units.SI.Length d(min=1e-6) = 0.02 "Outer diameter of tubes"
    annotation (Dialog(group="Geometry"));
  Modelica.Units.SI.Length s_1(min=2*1e-6) = 0.03
    "Distance between tubes (center to center) orthogonal to flow direction"
    annotation (Dialog(group="Geometry"));
  Modelica.Units.SI.Length s_2(min=0) = 0.026
